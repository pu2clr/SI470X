/*
   It is a SI470X receiver controlled by an ATtiny84 device  using I2C OLED 96" (128x64).
   ...
   ATtiny84 and SI470X wireup  
    ...
    | SI470X Function | Attiny84 REF pin | Physical pin  | 
    | ---------------- | -----------------| ------------- | 
    | SEEK_UP          |     3            |    10         | 
    | SEEK_DOWN        |     5            |     8         |
    | ENCODER_PIN_A    |     0            |    13         |
...
void setup() {
  ...
  // Restores the latest frequency  saved into the EEPROM
...
void loop() {
  ...
  // This SI470X Arduino Library implements almost all needed function to get all RDS information. 
